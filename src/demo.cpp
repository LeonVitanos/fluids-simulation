...
extern void vel_step(int N, float *u, float *v, float *u0, float *v0, float visc, float dt, float *boundaries);
...
static void clear_data(void)
{
	...
	for (i = 0; i < size; i++)
	{
		u[i] = v[i] = u_prev[i] = v_prev[i] = dens[i] = dens_prev[i] = boundaries[i] = 0.0f;
	}
}
...
static void idle_func(void)
{
	...
	vel_step(N, u, v, u_prev, v_prev, visc, dt, boundaries);
